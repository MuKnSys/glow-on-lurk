...
const contractPath = `${config.dapssDir}/if_gt_or_eq.glow`
...
describe("Checking 'if', with equal", () => {
    ...
    it("checking is state correct", function(done){
        ...
        .end(function (err, res){
            expect(err).to.be.null;
            expect(String(res.text), "Incorrect contract address").to.equal('{"_accounts":{"Jan":{"_balance":100},"Marcin":{"_balance":200}},"_contracts":{}}')
            done()
        })
    })
