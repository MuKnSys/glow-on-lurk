...
describe("Adding, should throw error", () => {
    ...
    it("#1 interaction call from user A, no parameters should throw error ", function(done){
    ...
    it("#1 interaction call from user B, no parameters should throw error", function(done){
