...
const contractParams = config.contractParamsEqual
const contractPtcps = config.contractPtcps
const silent = config.silentMode
var server = null
var address = null
describe("Checking 'if', with equal, false", () => {
    ...
    it("#1 interaction call from user A, else statement", function(done){
    ...
    it("#1 interaction call from user B, else statement", function(done){
